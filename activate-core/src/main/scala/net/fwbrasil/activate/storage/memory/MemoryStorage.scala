...
trait MemoryStorage extends Storage {
	...
	def initialize =
		storage =
			new scala.collection.mutable.HashMap[String, Entity] with java.io.Serializable with scala.collection.mutable.SynchronizedMap[String, Entity]
...
object MemoryStorage {
	def toStorage(
		...
		deletes: Map[Var[Any], EntityValue[Any]]): Unit = {
