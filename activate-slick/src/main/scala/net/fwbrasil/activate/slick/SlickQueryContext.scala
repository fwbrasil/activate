...
//    }
//    
//    implicit val entityIdManifest = manifest[AnyRef].asInstanceOf[Manifest[Entity#ID]]
//
//    implicit def EntityMappedColumnType[E <: Entity: ClassTag] = MappedColumnType.base[E, Entity#ID](_.id, byId[E](_).get)
//
