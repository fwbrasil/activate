...
//
//	def fork[R: Manifest](ms: Int = 100, mx: Int = 1024, others: Option[String] = None)(f: => R): Unit = {
//		val forkTask = new Fork(FunctionTask(() => f), classOf[FunctionTask[_]].getMethod("run"))
//		forkTask.addJvmOption("-Xmx" + mx + "M")
//		forkTask.addJvmOption("-Xms" + ms + "M")
//		others.map(forkTask.addJvmOption)
//		forkTask.execute
//		forkTask.waitFor
//		println(forkTask.getStdOut)
//		System.err.println(forkTask.getStdErr)
//		Option(forkTask.getException).map(throw _)
//		//		forkTask.getReturnValue.asInstanceOf[FunctionTaskReturn].value.asInstanceOf[R]
//	}
//}
////import org.gfork.Fork
////
